...
public class CustomViewStateAnimation {
    ...
    public static final ViewVisibilityAnimation GONE_ROTATE_AND_SCALE =
            new ViewVisibilityAnimation(View.GONE,
                    Arrays.asList(
    ...
    public static final ViewVisibilityAnimation VISIBLE_ROTATE_AND_SCALE_BACK =
            new ViewVisibilityAnimation(View.VISIBLE,
                    Arrays.asList(

...
public class PropertyDescription {
     ...
     */
    public PropertyDescription(View targetView, Property<View, Float> property, float startValue, float targetValue) {
     ...
     */
    public PropertyDescription(View targetView, String tag, float startValue, float targetValue) {
        mTargetView = new WeakReference(targetView);
        this.mTag = tag;
    ...
    public PropertyDescription(View targetView, String tag, float startValue, Path path, PathEvaluator.PathMode pathMode, PathEvaluator sharedEvaluator) {
        mTargetView = new WeakReference(targetView);
        this.mTag = tag;
        this.mStartValue = startValue;
        this.mPath = path;
    ...
    public PropertyDescription(View targetView, Property<View, Float> property, float startValue, Path path, PathEvaluator.PathMode pathMode, PathEvaluator sharedEvaluator) {
        mTargetView = new WeakReference(targetView);
